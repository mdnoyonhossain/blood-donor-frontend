...
export default function MultipleSelectFieldChip({ schedules, selectedScheduleIds, setSelectedScheduleIds }: any) {
    ...
    return (
        <div>
            <FormControl sx={{ width: 300 }}>
                <InputLabel id='demo-multiple-chip-label'>Schedule Time</InputLabel>
                <Select
