...
const ProfileUpdateModal = ({ open, setOpen, id }: TProps) => {
    ...
    return (
        <PHFullScreenModal open={open} setOpen={setOpen} title='Update Profile'>
            <PHForm onSubmit={submitHandler} defaultValues={doctorData} resolver={zodResolver(validationSchema)}>
                ...
                <Button type='submit' disabled={updating} startIcon={<SaveIcon />}>Save</Button>
            </PHForm>
        </PHFullScreenModal>
    );
};
